...
def test_apply_noise_reduction(mock_reduce_noise, mock_soundfile, mock_exists, tmp_path):
    ...
    # The first call returns a context manager that enters and returns mock_in_file
    # The second call returns a context manager that enters and returns mock_out_file
    ctx1 = MagicMock()
